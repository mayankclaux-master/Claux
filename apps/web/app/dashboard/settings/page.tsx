...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-claux-text mb-2">Settings</h1>
        <p className="text-claux-muted">Manage your business profile and integration settings</p>
      </div>
